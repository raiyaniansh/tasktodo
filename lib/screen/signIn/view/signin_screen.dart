        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Container(width: 30.w,height: 10.h,child: Image.network("https://dwglogo.com/wp-content/uploads/2016/02/Amazoncom-yellow-arrow.png",color: Colors.red,fit: BoxFit.cover,)),
              SizedBox(
                height: 15.h,
              ),
              TextField(
              ...
              Row(
                ...
                children: [
                  InkWell(
                    onTap: () async {
                      String? msg = await controller.SingIn();
                      if (msg == "success") {
              ...
              InkWell(
                onTap: () async {
                  String msg =
                      await FireBase.fireBase.signInWithGoogle();
                  if (msg == "success") {
                    Get.offAndToNamed('/home');
                  }
                },
